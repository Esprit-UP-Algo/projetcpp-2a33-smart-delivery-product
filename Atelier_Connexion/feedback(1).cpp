...
QSqlQueryModel* FeedBack::afficher()
{
    QSqlQueryModel* model=new QSqlQueryModel();
      ...
      model->setHeaderData(2, Qt::Horizontal, QObject::tr("delivery"));
      model->setHeaderData(3, Qt::Horizontal, QObject::tr("com"));
      model->setHeaderData(4, Qt::Horizontal, QObject::tr("package"));
      model->setHeaderData(5, Qt::Horizontal, QObject::tr("resolution"));
